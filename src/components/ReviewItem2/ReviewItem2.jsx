...
export const ReviewItem2 = ( { name, date, image, comment } ) => {
    ...
    return ( <>
        <div data-aos="flip-right" data-aos-duration="1000"
            ...
            <span className="quotesRight">
                <img
                    src="https://res.cloudinary.com/ds0dc8rd0/image/upload/v1683927565/la-gertrudis/iconos/qjig6dgpiqlbbqit9mrz.png"
